...
public class HelloWorldResource {
    ...
    @Produces(MediaType.TEXT_HTML)
    @PermitAll
    public DataView dataView(@Auth User user, @Context UriInfo uriInfo, @Context HttpHeaders headers) {

        return new DataView(uriInfo, new ArrayList<Data>(), user);
    }
    ...
    @Produces(MediaType.TEXT_HTML)
    @PermitAll
    public GraphView obrView(@Auth User user, @Context UriInfo uriInfo, @Context HttpHeaders headers) {
